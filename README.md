        ...
        <div class="row">
            <div class="col-12">
                <div class="mt-3" id="actions">
                    ...
                    <%--<asp:GridView runat="server" AutoGenerateColumns="False" DataKeyNames="CarId" AllowSorting="True" ID="gvGridView" CssClass="table table-striped table-bordered" DataSourceID="SqlDataSource1" OnSelectedIndexChanged="gvGridView_SelectedIndexChanged" Width="500px">
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Action" ItemStyle-CssClass="gv-action-column">
                                <ItemTemplate>
                                    <asp:HyperLink ID="EditButton" runat="server" CommandName="Edit" NavigateUrl='<% "UpdateCarAdmin.aspx?CarId=" + Eval("CarId") %>' Text="Edit" CssClass="btn btn-sm btn-primary mr-2" />
                                    <asp:HyperLink ID="DeleteButton" runat="server" CommandName="Delete" href="Display()" Text="Delete" CssClass="btn btn-sm btn-danger" OnClientClick="return confirm('Are you sure you want to delete this item?');" />
                                </ItemTemplate>
                            </asp:TemplateField>
